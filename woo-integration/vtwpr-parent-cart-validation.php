...
//    add_filter( 'woocommerce_before_checkout_process', array(&$this, 'vtwpr_woo_validate_order'), 1);   
...
/*
if ($product_id == '10') { 
echo 'product_session_info= <pre>'.print_r($vtwpr_info['product_session_info'], true).'</pre>' ;  
