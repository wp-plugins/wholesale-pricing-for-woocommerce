     jQuery(document).ready(function($) {
            ...
            //****************************  
                            ...
                            $("#wholesale_pricing-examples-more2").click(function(){   //in help panel 0
                                $(".selection-panel-5").show("slow"); 
                                $("#wholesale_pricing-examples-more2").hide();
                                $("#wholesale_pricing-examples-less2").show("slow");                            
                            });
                            $("#wholesale_pricing-examples-less2").click(function(){  //in help panel 0
                                $(".selection-panel-5").hide("slow");  //hide all selection-panels
                                $("#wholesale_pricing-examples-less2").hide();
                                $("#wholesale_pricing-examples-more2").show("slow");                            
                            });                            
                        ...
                        //**************  
                        $("#vtwpr-panel-5-help1-more").click(function(){
                            $("#vtwpr-panel-5-help1-text").show("slow"); 
                            $("#vtwpr-panel-5-help1-more").hide();
                            $("#vtwpr-panel-5-help1-less").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help1-less").click(function(){
                            $("#vtwpr-panel-5-help1-text").hide("slow");  
                            $("#vtwpr-panel-5-help1-less").hide();
                            $("#vtwpr-panel-5-help1-more").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help2-more").click(function(){
                            $("#vtwpr-panel-5-help2-text").show("slow"); 
                            $("#vtwpr-panel-5-help2-more").hide();
                            $("#vtwpr-panel-5-help2-less").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help2-less").click(function(){
                            $("#vtwpr-panel-5-help2-text").hide("slow");  
                            $("#vtwpr-panel-5-help2-less").hide();
                            $("#vtwpr-panel-5-help2-more").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help3-more").click(function(){
                            $("#vtwpr-panel-5-help3-text").show("slow"); 
                            $("#vtwpr-panel-5-help3-more").hide();
                            $("#vtwpr-panel-5-help3-less").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help3-less").click(function(){
                            $("#vtwpr-panel-5-help3-text").hide("slow");  
                            $("#vtwpr-panel-5-help3-less").hide();
                            $("#vtwpr-panel-5-help3-more").show("slow");                            
                        });                        
                        $("#vtwpr-panel-5-help4-more").click(function(){
                            $("#vtwpr-panel-5-help4-text").show("slow"); 
                            $("#vtwpr-panel-5-help4-more").hide();
                            $("#vtwpr-panel-5-help4-less").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help4-less").click(function(){
                            $("#vtwpr-panel-5-help4-text").hide("slow");  
                            $("#vtwpr-panel-5-help4-less").hide();
                            $("#vtwpr-panel-5-help4-more").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help5-more").click(function(){
                            $("#vtwpr-panel-5-help5-text").show("slow"); 
                            $("#vtwpr-panel-5-help5-more").hide();
                            $("#vtwpr-panel-5-help5-less").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help5-less").click(function(){
                            $("#vtwpr-panel-5-help5-text").hide("slow");  
                            $("#vtwpr-panel-5-help5-less").hide();
                            $("#vtwpr-panel-5-help5-more").show("slow");                            
                        });                        
                        $("#vtwpr-panel-5-help6-more").click(function(){
                            $("#vtwpr-panel-5-help6-text").show("slow"); 
                            $("#vtwpr-panel-5-help6-more").hide();
                            $("#vtwpr-panel-5-help6-less").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help6-less").click(function(){
                            $("#vtwpr-panel-5-help6-text").hide("slow");  
                            $("#vtwpr-panel-5-help6-less").hide();
                            $("#vtwpr-panel-5-help6-more").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help7-more").click(function(){
                            $("#vtwpr-panel-5-help7-text").show("slow"); 
                            $("#vtwpr-panel-5-help7-more").hide();
                            $("#vtwpr-panel-5-help7-less").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help7-less").click(function(){
                            $("#vtwpr-panel-5-help7-text").hide("slow");  
                            $("#vtwpr-panel-5-help7-less").hide();
                            $("#vtwpr-panel-5-help7-more").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help8-more").click(function(){
                            $("#vtwpr-panel-5-help8-text").show("slow"); 
                            $("#vtwpr-panel-5-help8-more").hide();
                            $("#vtwpr-panel-5-help8-less").show("slow");                            
                        });
                        $("#vtwpr-panel-5-help8-less").click(function(){
                            $("#vtwpr-panel-5-help8-text").hide("slow");  
                            $("#vtwpr-panel-5-help8-less").hide();
                            $("#vtwpr-panel-5-help8-more").show("slow");                            
                        });
