 ...
 */
            ...
            //*************************************  
                     ...
                     //         $("#action_group_box").show("slow");  
                            ...
                            function initAllValues() {      
                              ...
                              $(".vtwpr-error").hide("slow");  //hide all previous errors
                              $(".vtwpr-error2").hide("slow");  //hide all previous errors
            ...
            //****************************  
                            ...
                            $("#wholesale_pricing-title-more").click(function(){
                                $(".selection-panel-0").show("slow"); 
                                $("#wholesale_pricing-title-more").hide();
                                $("#wholesale_pricing-title-more2").hide();
                                $("#wholesale_pricing-title-less").show("slow");
                                $("#wholesale_pricing-title-less2").show("slow");                            
                            });
                            $("#wholesale_pricing-title-less").click(function(){
                                $(".selection-panel-0").hide("slow");  //hide all selection-panels
                                $("#wholesale_pricing-title-less").hide();
                                $("#wholesale_pricing-title-less2").hide();
                                $("#wholesale_pricing-title-more").show("slow");
                                $("#wholesale_pricing-title-more2").show("slow");                            
                            });
                            $("#wholesale_pricing-title-more2").click(function(){
                                $(".selection-panel-0").show("slow"); 
                                $("#wholesale_pricing-title-more").hide();
                                $("#wholesale_pricing-title-more2").hide();
                                $("#wholesale_pricing-title-less").show("slow");
                            ...
                            $("#wholesale_pricing-title-less2").click(function(){
                                $(".selection-panel-0").hide("slow");  //hide all selection-panels
                                $("#wholesale_pricing-title-less").hide();
                                $("#wholesale_pricing-title-less2").hide();
                                $("#wholesale_pricing-title-more").show("slow");
                            ...
                            $("#wholesale_pricing-examples-more").click(function(){
                                $(".selection-panel-wrapper .selection-panel-5").show("slow"); 
                                $("#wholesale_pricing-examples-more").hide();
                                $("#wholesale_pricing-examples-less").show("slow");                       
                            });
                            $("#wholesale_pricing-examples-less").click(function(){
                                $(".selection-panel-wrapper .selection-panel-5").hide("slow");  //hide all selection-panels
                                $("#wholesale_pricing-examples-less").hide();
                                $("#wholesale_pricing-examples-more").show("slow");                      
                            });
                            $("#wholesale_pricing-examples-more2").click(function(){
                                $(".selection-panel-0 .selection-panel-5").show("slow"); 
                                $(".selection-panel-0 #wholesale_pricing-examples-more2").hide();
                                $(".selection-panel-0 #wholesale_pricing-examples-less2").show("slow");                            
                            });
                            $("#wholesale_pricing-examples-less2").click(function(){
                                $(".selection-panel-0 .selection-panel-5").hide("slow");  //hide all selection-panels
                                $(".selection-panel-0 #wholesale_pricing-examples-less2").hide();
                                $(".selection-panel-0 #wholesale_pricing-examples-more2").show("slow");                            
                            });
     ...
     //end old stuff
            ...
            //********************************************                                                                  
                        ...
                        function cartChoiceIn() {
                          ...
                          $("#vtwpr-pop-in-groups-cntl").hide(); 
                          $("#vtwpr-pop-in-groups-cntl-help").hide(); 
                          $("#buy_group_line_remainder").hide();   
                        };
                        function groupChoiceIn() {
                          $("#buy_group_line_remainder").show("slow"); //mwntest
                          $("#vtwpr-pop-in-groups-cntl").show("slow"); //mwntest
                          $("#vtwpr-pop-in-groups-cntl-help").show("slow");
                          $("#vtwpr-pop-in-cntl").show("slow");
                          $("#inPop-varProdID-cntl").hide("slow");
                          $("#singleChoiceIn-span").hide("slow");
                        ...
                        function varChoiceIn() {
                          $("#buy_group_line_remainder").show("slow"); //mwntest
                          $("#vtwpr-pop-in-groups-cntl").hide("slow"); //mwntest
                          $("#vtwpr-pop-in-groups-cntl-help").hide("slow");
                          $("#vtwpr-pop-in-cntl").hide("slow");
                        ...
                        function cartChoiceOut() {                            
                          $("#vtwpr-pop-out-cntl").hide("slow");
                          $("#vtwpr-pop-out-cntl-help").hide("slow");
                        ...
                        function groupChoiceOut() {
                          ...
                          $("#vtwpr-pop-out-cntl").show("slow");
                          $("#vtwpr-pop-out-cntl-help").show("slow");
                          $("#actionPop-varProdID-cntl").hide("slow");
                          $("#singleChoiceOut-span").hide("slow");
              ...
              //**************************************************************************************************                            
                        $("#ajaxVariationIn").click(function(){
                            ...
                            jQuery.ajax({
                               ...
                               data :  {action: "vtwpr_ajax_load_variations_in", inVarProdID: VarProdIDin } ,
                        ...
                        $("#ajaxVariationOut").click(function(){
                            ...
                            jQuery.ajax({
                               ...
                               data :  {action: "vtwpr_ajax_load_variations_out", outVarProdID: VarProdIDout } ,
                              success: function(response) {                                        
                        ...
                        //  Info Panel Toggles
                        //**************                         
                        $("#vtwpr-info1-help-all").click(function(){
                            $(".vtwpr-info1-help-text").toggle("slow");                         
                        });
                        $("#vtwpr-info1-help0").click(function(){
                            $("#vtwpr-info1-help0-text").toggle("slow");                           
                        });
                        $("#vtwpr-info1-help1").click(function(){
                            $("#vtwpr-info1-help1-text").toggle("slow");                           
                        }); 
                        $("#vtwpr-info1-help2").click(function(){
                            $("#vtwpr-info1-help2-text").toggle("slow");                           
                        }); 
                        $("#vtwpr-info1-help3").click(function(){
                            $("#vtwpr-info1-help3-text").toggle("slow");                           
                        }); 
                        $("#vtwpr-info1-help4").click(function(){
                            $("#vtwpr-info1-help4-text").toggle("slow");                           
                        }); 
                        $("#vtwpr-info1-help5").click(function(){
                            $("#vtwpr-info1-help5-text").toggle("slow");                           
                        });                       
                        $("#vtwpr-info1-help6").click(function(){
                            $("#vtwpr-info1-help6-text").toggle("slow");                           
                        });                       
                        
                                                
                        /*since there are 2 occurrences of each of these panels, must use Class!*/
                        $(".vtwpr-shortcode-details1-help").click(function(){
                            $(".vtwpr-shortcode-details1").toggle("slow");                           
                        });                                                          
                        $(".vtwpr-shortcode-details2-help").click(function(){
                            $(".vtwpr-shortcode-details2").toggle("slow");                           
                        });  
                        $(".vtwpr-shortcode-details3-help").click(function(){
                            $(".vtwpr-shortcode-details3").toggle("slow");                           
                        }); 
                         
                        $(".vtwpr-cartWidget-details1-help").click(function(){
                            $(".vtwpr-cartWidget-details1").toggle("slow");                           
                        });
                        ...
                        //**************  
                        $("#selection-panel-0 #vtwpr-panel-5-help1-more").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help1-text").show("slow"); 
                            $("#selection-panel-0 #vtwpr-panel-5-help1-more").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help1-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help1-less").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help1-text").hide("slow");  
                            $("#selection-panel-0 #vtwpr-panel-5-help1-less").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help1-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help2-more").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help2-text").show("slow"); 
                            $("#selection-panel-0 #vtwpr-panel-5-help2-more").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help2-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help2-less").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help2-text").hide("slow");  
                            $("#selection-panel-0 #vtwpr-panel-5-help2-less").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help2-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help3-more").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help3-text").show("slow"); 
                            $("#selection-panel-0 #vtwpr-panel-5-help3-more").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help3-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help3-less").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help3-text").hide("slow");  
                            $("#selection-panel-0 #vtwpr-panel-5-help3-less").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help3-more").show("slow");                            
                        });                        
                        $("#selection-panel-0 #vtwpr-panel-5-help4-more").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help4-text").show("slow"); 
                            $("#selection-panel-0 #vtwpr-panel-5-help4-more").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help4-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help4-less").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help4-text").hide("slow");  
                            $("#selection-panel-0 #vtwpr-panel-5-help4-less").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help4-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help5-more").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help5-text").show("slow"); 
                            $("#selection-panel-0 #vtwpr-panel-5-help5-more").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help5-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help5-less").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help5-text").hide("slow");  
                            $("#selection-panel-0 #vtwpr-panel-5-help5-less").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help5-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help6-more").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help6-text").show("slow"); 
                            $("#selection-panel-0 #vtwpr-panel-5-help6-more").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help6-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help6-less").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help6-text").hide("slow");  
                            $("#selection-panel-0 #vtwpr-panel-5-help6-less").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help6-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help7-more").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help7-text").show("slow"); 
                            $("#selection-panel-0 #vtwpr-panel-5-help7-more").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help7-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help7-less").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help7-text").hide("slow");  
                            $("#selection-panel-0 #vtwpr-panel-5-help7-less").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help7-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help8-more").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help8-text").show("slow"); 
                            $("#selection-panel-0 #vtwpr-panel-5-help8-more").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help8-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtwpr-panel-5-help8-less").click(function(){
                            $("#selection-panel-0 #vtwpr-panel-5-help8-text").hide("slow");  
                            $("#selection-panel-0 #vtwpr-panel-5-help8-less").hide();
                            $("#selection-panel-0 #vtwpr-panel-5-help8-more").show("slow");                            
                        });
                        ...
                        //**************  
                        $(".selection-panel-wrapper #vtwpr-panel-5-help1-more").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help1-text").show("slow"); 
                            $(".selection-panel-wrapper #vtwpr-panel-5-help1-more").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help1-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help1-less").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help1-text").hide("slow");  
                            $(".selection-panel-wrapper #vtwpr-panel-5-help1-less").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help1-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help2-more").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help2-text").show("slow"); 
                            $(".selection-panel-wrapper #vtwpr-panel-5-help2-more").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help2-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help2-less").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help2-text").hide("slow");  
                            $(".selection-panel-wrapper #vtwpr-panel-5-help2-less").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help2-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help3-more").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help3-text").show("slow"); 
                            $(".selection-panel-wrapper #vtwpr-panel-5-help3-more").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help3-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help3-less").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help3-text").hide("slow");  
                            $(".selection-panel-wrapper #vtwpr-panel-5-help3-less").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help3-more").show("slow");                            
                        });                        
                        $(".selection-panel-wrapper #vtwpr-panel-5-help4-more").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help4-text").show("slow"); 
                            $(".selection-panel-wrapper #vtwpr-panel-5-help4-more").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help4-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help4-less").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help4-text").hide("slow");  
                            $(".selection-panel-wrapper #vtwpr-panel-5-help4-less").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help4-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help5-more").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help5-text").show("slow"); 
                            $(".selection-panel-wrapper #vtwpr-panel-5-help5-more").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help5-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help5-less").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help5-text").hide("slow");  
                            $(".selection-panel-wrapper #vtwpr-panel-5-help5-less").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help5-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help6-more").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help6-text").show("slow"); 
                            $(".selection-panel-wrapper #vtwpr-panel-5-help6-more").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help6-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help6-less").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help6-text").hide("slow");  
                            $(".selection-panel-wrapper #vtwpr-panel-5-help6-less").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help6-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help7-more").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help7-text").show("slow"); 
                            $(".selection-panel-wrapper #vtwpr-panel-5-help7-more").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help7-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help7-less").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help7-text").hide("slow");  
                            $(".selection-panel-wrapper #vtwpr-panel-5-help7-less").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help7-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help8-more").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help8-text").show("slow"); 
                            $(".selection-panel-wrapper #vtwpr-panel-5-help8-more").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help8-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtwpr-panel-5-help8-less").click(function(){
                            $(".selection-panel-wrapper #vtwpr-panel-5-help8-text").hide("slow");  
                            $(".selection-panel-wrapper #vtwpr-panel-5-help8-less").hide();
                            $(".selection-panel-wrapper #vtwpr-panel-5-help8-more").show("slow");                            
                        });                        
